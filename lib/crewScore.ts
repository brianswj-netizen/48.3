...
export const SCORE_RULES = {
  ...
  sapjil_post:           { label: '삽질기 글 작성', points: 30 },
  sapjil_reaction:       { label: '삽질기 리액션',  points: 0.5, note: '하루 최대 5점' },
  creature_post:         { label: '나의 피조물 등록', points: 50 },
  creature_comment:      { label: '피조물 댓글',     points: 2 },
  creature_reaction:     { label: '피조물 리액션',   points: 0.5 },
